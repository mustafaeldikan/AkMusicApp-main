...
const MusicModal = ({ isModalVisible, toggleModal }) => {
    return (
        <Modal
            ...
            <LinearGradient
                ...
                <View style={styles.container}>
                    ...
                    <View style={{ alignItems: 'center', marginVertical: 20 }}>
                        <Image width={wp('85%')} height={wp('75%')} borderRadius={15} source={{
                            uri: 'https://t4.ftcdn.net/jpg/04/10/17/95/360_F_410179527_ExxSzamajaCtS16dyIjzBRNruqlU5KMA.jpg',
                        }} />
                    </View>

                    <View>
                        <Text style={{ color: '#fff', fontSize: 20, fontWeight: '400' }}>Sabki Baaratein Aayi</Text>
                        <Text style={{ color: 'gray', fontSize: 15 }}>4 mins 27 secs. Dev Negi, Seepi Jha, jaspi...</Text>
                    </View>
                    ...
                    <View style={{ marginVertical: 20 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <Text style={{ color: '#fff', fontSize: 10, paddingHorizontal: 15 }}>00.01</Text>
                            <Text style={{ color: '#fff', fontSize: 10, paddingHorizontal: 15 }}>00.01</Text>
                        </View>
                    </View>
